...
const Home = () => {
  ...
  <h2 className="font-serif font-display font-bold text-3xl md:text-4xl lg:text-5xl mb-6 text-[#5c4a4a]">
    Capturing Timeless Moments
  </h2>
  <p className="font-light text-[#7a6868] mb-6 leading-relaxed">
  ...
  <div className="md:order-first bg-[#ecdede] p-12 md:p-24 flex justify-end items-center">
    <div className="max-w-md">
      <div className="w-24 h-2 bg-[#5c4a4a] mb-4"></div>
      <h2 className="font-serif font-display font-bold text-2xl md:text-3xl lg:text-4xl mb-6 text-[#5c4a4a]">
        Elegant Wedding Moments
      </h2>
      <p className="font-light text-[#7a6868] text-sm md:text-base mb-6 leading-relaxed">
        Discover stories captured with grace and warmth. Each frame tells the beauty of real moments on your special day.
      </p>
      <a
        href="/about"
        className="inline-block border-2 border-[#5c4a4a] font-light text-[#5c4a4a] text-sm uppercase tracking-widest py-3 px-8 hover:bg-[#5c4a4a] hover:text-white transition-colors duration-300"
      >
        Read more
      </a>
    </div>
      ...
      <div className="relative w-full px-6 py-16 md:py-24 lg:py-32 z-5">
        ...
        <div className="relative z-5 text-center text-white max-w-3xl mx-auto">
          ...
          <NavLink to="/contact" className="inline-block bg-[#7c4a5c] text-[#ffffff] uppercase text-sm tracking-widest font-heading px-8 py-4 transition">Book Now</NavLink>
        </div>
      </div>
